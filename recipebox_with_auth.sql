...
--
-- Host: localhost    Database: recipes_with_auth
-- ------------------------------------------------------
...
CREATE TABLE `recipes` (
  ...
  CONSTRAINT `FK_Recipes_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`)
...
CREATE TABLE `recipetags` (
  `RecipeTagId` int NOT NULL AUTO_INCREMENT,
  `RecipeId` int NOT NULL,
  `TagId` int NOT NULL,
  PRIMARY KEY (`RecipeTagId`),
  KEY `IX_RecipeTags_RecipeId` (`RecipeId`),
  KEY `IX_RecipeTags_TagId` (`TagId`),
...
CREATE TABLE `tags` (
  ...
  `Cuisine` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `UserId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`TagId`),
...
-- Dump completed on 2023-01-24 20:19:00
